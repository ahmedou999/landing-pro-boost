...
const translations = {
  fr: {
    ...
    'advantages.advantage3.desc': 'WhatsApp, Calendly, Google Analytics et tous vos outils favoris intégrés nativement.',
    ...
    'pricing.pack.feature4': 'Intégrations WhatsApp & Calendly',
    ...
    'faq.a5': 'Oui, nous intégrons facilement les outils les plus utilisés comme WhatsApp, Calendly, Google Analytics, Facebook Pixel ou encore Mailchimp. Pour d\'autres intégrations spécifiques, nous étudions la faisabilité au cas par cas.',
  ...
  en: {
    ...
    'advantages.advantage3.desc': 'WhatsApp, Calendly, Google Analytics and all your favorite tools integrated natively.',
    ...
    'pricing.pack.feature4': 'WhatsApp & Calendly integrations',
    ...
    'faq.a5': 'Yes, we easily integrate the most used tools like WhatsApp, Calendly, Google Analytics, Facebook Pixel, and Mailchimp. For other specific integrations, we study feasibility case by case.',
