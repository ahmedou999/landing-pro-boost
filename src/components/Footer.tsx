          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
            ...
            <div className="space-y-3 md:space-y-4">
              ...
              <p className="text-sm md:text-base text-muted-foreground">
                {language === 'fr' 
                  ? 'Spécialiste en landing pages haute conversion pour entrepreneurs, freelances et petites entreprises.' 
                  : 'High-conversion landing page specialist for entrepreneurs, freelancers and small businesses.'}
              </p>
            ...
            <div className="space-y-3 md:space-y-4">
              ...
              <div className="space-y-3">
                <button 
                  onClick={() => window.open(`https://wa.me/33123456789?text=${language === 'fr' ? 'Bonjour, je souhaite obtenir des informations sur vos landing pages' : 'Hello, I would like information about your landing pages'}`, '_blank')} 
                  className="btn-whatsapp w-full text-sm md:text-base py-2 md:py-3"
                >
